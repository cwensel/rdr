...
at [Stage 08.1 Cluster-reconcile](../../flow/08.1-cluster-reconcile.md), over a
...
disagree, duplicate, or leave a gap between them.
...
For each finding, emit:
  ...
  TYPE: [contradiction | duplication | gap]
...
the flow; see [Stage 08.1](../../flow/08.1-cluster-reconcile.md) for the
